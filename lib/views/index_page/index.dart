...
//    print(startX);
//    print(startY);
//    print(e.globalPosition.direction);print(e.globalPosition);
//    print(Offset(1, 2).direction);
//    print(Offset(1, 2).distance);
//    print(Offset(1, 2).distanceSquared);
//    print(Offset(1, 2).isFinite);
  }
  ...
  void moveUpdate(e) {
    ...
    if ((moveX - startX).abs() > (moveY - startY).abs()) {
      ...
      _moveT = screen.setWidth(preMove + moveX - startX);
